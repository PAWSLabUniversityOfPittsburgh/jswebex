...
(function() {
  var OutcomeDocument, OutcomeService, crypto, errors, http, https, navigateXml, url, utils, uuid, xml2js, xml_builder;
  ...
  OutcomeService = (function() {
    ...
    function OutcomeService(provider1, language1) {
      ...
      this.source_did = body.lis_result_sourcedid;
      this.result_data_types = body.ext_outcome_data_values_accepted && body.ext_outcome_data_values_accepted.split(',') || [];
  ...
  exports.init = function(provider) {
    if (provider.body.lis_outcome_service_url && provider.body.lis_result_sourcedid) {
      return provider.outcome_service = new OutcomeService(provider);
    } else {
